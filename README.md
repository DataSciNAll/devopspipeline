...
!!!JVSyncThis tutorial will help you to understand how to build the Continuous Integration and Continuous Delivery pipeline for Data Science work. We will be using the VSTS Team Project build and release tool for it. 
